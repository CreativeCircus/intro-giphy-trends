...
var getTrends = function getTrends() {
  var GIPHY_API = 'https://api.giphy.com/v1/gifs/trending?api_key=' + GIPHY_API_KEY + '&rating=G&';
  axios.get(GIPHY_API).then(function (response) {
...
var showTrends = function showTrends(data) {
  console.log(data); // you work here
